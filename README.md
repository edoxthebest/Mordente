...
As a reference, here follows the output of the first experiment (some lines are omitted for brevity).
```
root@57a165d645c4:/usr/local/Mordente# mordente queries/experiments policies/p1 policies/p2 
2026-02-14 10:42:22,269 [INFO ]  Starting comparison of the specified policies.
2026-02-14 10:42:22,299 [INFO ]  Loading policy #1 (p1).
...
2026-02-14 10:53:39,439 [INFO ]  Loaded policy #1 in 677.1396520137787.
2026-02-14 10:53:39,440 [INFO ]  Loading policy #2 (p2).
...
2026-02-14 11:04:43,917 [INFO ]  Loaded policy #2 in 664.4777376651764.
2026-02-14 11:05:18,996 [INFO ]  Built InfoFlowGraph [N 769] [E 615737] in 34.82881307601929.
2026-02-14 11:05:19,056 [INFO ]  Query perfomed `label_2 (CRITICAL) and not label_1 (CRITICAL)`
2026-02-14 11:05:19,056 [INFO ]         FALSE, the following labels are counterexamples {('viewcompiler_exec', 'system_file')}
2026-02-14 11:05:20,265 [INFO ]  Query perfomed `ito_2(label_2(CRITICAL)) and not ito_1(label_2(CRITICAL))`
2026-02-14 11:05:20,265 [INFO ]         TRUE
2026-02-14 11:05:21,333 [INFO ]  Query perfomed `(label_2(UNTRUSTED) and ito_2(label_2(CRITICAL))) and not (label_2(UNTRUSTED) and ito_1(label_2(CRITICAL)))`
2026-02-14 11:05:21,333 [INFO ]         TRUE
2026-02-14 11:05:22,410 [INFO ]  Query perfomed `(label_2(UNTRUSTED) and ito_2(label_2(CRITICAL))) and not (label_1(UNTRUSTED) and ito_1(label_1(CRITICAL)))`
2026-02-14 11:05:22,410 [INFO ]         FALSE, the following labels are counterexamples {('block_device', 'userdata_exp_block_device'), ('system_data_file', 'system_userdir_file')}
2026-02-14 11:05:23,668 [INFO ]  Query perfomed `(label_2(UNTRUSTED) and ito_2(label_2(CRITICAL)) and label_1(UNTRUSTED)) and not ito_1(label_1(CRITICAL))`
2026-02-14 11:05:23,668 [INFO ]         TRUE
2026-02-14 11:05:24,129 [INFO ]  Query perfomed `(label_2(CRITICAL) and ifrom_2(label_2(UNTRUSTED))) and not (label_2(CRITICAL) and ifrom_1(label_2(UNTRUSTED)))`
2026-02-14 11:05:24,129 [INFO ]         FALSE, the following labels are counterexamples {('viewcompiler_exec', 'system_file')}
2026-02-14 11:05:24,703 [INFO ]  Query perfomed `(ito_2(label_2(CRITICAL)) and label_1(UNTRUSTED)) and not label_2(TRUSTED)`
2026-02-14 11:05:24,704 [INFO ]         FALSE, the following labels are counterexamples {('modem_userdata_file', 'modem_userdata_file'), ('hal_neuralnetworks_darwinn_exec', 'hal_neuralnetworks_darwinn_exec'), ('mnt_user_file', 'mnt_user_file'), ('user_profile_data_file', 'user_profile_data_file'), ('dm_user_device', 'dm_user_device'), ('media_userdir_file', 'media_userdir_file'), ('vendor_userdir_file', 'vendor_userdir_file'), ('tee_userdata_block_device', 'tee_userdata_block_device'), ('sensor_debug_data_file', 'sensor_debug_data_file'), ('system_userdir_file', 'system_userdir_file'), ('rild_debug_socket', 'rild_debug_socket'), ('gpuservice_exec', 'gpuservice_exec'), ('snapuserd_log_data_file', 'snapuserd_log_data_file'), ('user_profile_root_file', 'user_profile_root_file'), ('kmsg_debug_device', 'kmsg_debug_device'), ('system_ndebug_socket', 'system_ndebug_socket'), ('hal_threadnetwork_default_exec', 'hal_threadnetwork_default_exec'), ('snapuserd_socket', 'snapuserd_socket'), ('dump_display_userdebug_exec', 'dump_display_userdebug_exec'), ('userdata_sysdev', 'userdata_sysdev'), ('network_watchlist_data_file', 'network_watchlist_data_file'), ('modem_userdata_block_device', 'modem_userdata_block_device'), ('userspace_reboot_metadata_file', 'userspace_reboot_metadata_file'), ('snapuserd_proxy_socket', 'snapuserd_proxy_socket'), ('userdata_block_device', 'userdata_block_device'), ('hal_neuralnetworks_darwinn_data_file', 'hal_neuralnetworks_darwinn_data_file'), ('misc_user_data_file', 'misc_user_data_file'), ('snapuserd_exec', 'snapuserd_exec')}
2026-02-14 11:05:24,704 [INFO ]  Perfomed 7 queries in 5.705982446670532.
```
